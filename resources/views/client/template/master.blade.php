...
<body class="d-flex flex-column min-vh-100">
    ...
    <section id="content">
        <div class="container mt-5 mb-5">
            ...
            @php
                $upcomingSeminars = $seminar->filter(function ($item) {
                    $seminarDate = \Carbon\Carbon::parse($item->seminar_date);
                    $now = \Carbon\Carbon::now();
                    return $now->lt($seminarDate->addDay());
                });
            @endphp
            ...
            @else
                <div class="row">
                    @foreach ($upcomingSeminars as $item)
                        <div class="col-md-4 mb-3 d-flex justify-content-center">
                            <div class="card h-100 shadow" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Quota Left: {{ $item->quota }}</p>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-4 text-center">
                                <img class="mb-2" src="{{ asset($item->image) }}" style="width: 200px"
                                    alt="">
                            </div>
                            <div class="col-sm-8 text-center">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label for="quota">Quota Left :</label>
                                    </div>
                                    <div class="col-sm-8">
                                        <p>{{ $item->quota }}</p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label for="seminar_date">Speaker :</label>
                                    </div>
                                    <div class="col-sm-8">
                                        <p>{{ $item->speaker }}</p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label for="seminar_date">Description :</label>
                                    </div>
                                    <div class="col-sm-8">
    ...
    <footer class="py-1 mt-auto">
        <div class="container">
            <p class="text-center m-2">Copyright &copy; Ahmad Faisal 2023</p>
        </div>
    </footer>
    ...
    <script>
        $('.register-btn').on('click', function() {
            ...
            $.get('/check-registration/' + seminarId, function(response) {
                if (response.registered) {
                    button.prop('disabled', true).text('Registered');
                } else {
